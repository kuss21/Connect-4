...
# command to run:
## sudo python3 DrawingEverythingInOneFunct.py --led-rows=32 --led-cols=64 --led-slowdown-gpio=4 --led-brightness=80
        ...
        while True:
            ...
            while True:
                ...
                if(not leftInput):
                    ...
                    ###################### NEED TO NOT BE ABLE TO PLACE ANYTHING AND KEEP PLAYER THE SAME UNTIL VALID PLACEMENT ######################## MAYBE USE ERIK'S FUNCTION (colNotFull())
